...
%    init_matrix(Matrix1),
%
%    fill_matrix(Matrix1,Matrix2),    format('Matriz 9x9 vazia:~n~w~n', [Matrix1]),
%
%
%    format('Matriz 9x9 Preenchida:~n~w~n', [Matrix2]),    % Acessa o elemento na posição (2, 3)
%
...
%
%    (verify_in_column(0, Matrix2, 3) -> format('Elemento 0 encontrado na coluna 3~n') ; format('Elemento 0 não encontrado na coluna 3~n')),    (verify_in_quadrant(Matrix2, 2, 3, 0) -> format('Elemento 0 encontrado no quadrante 3x3 contendo (2, 3)~n') ; format('Elemento 0 não encontrado no quadrante 3x3 contendo (2, 3)~n')),
%
%    
%
%    (compare_9x9_matrices(Matrix1, Matrix2) ->  format('As matrizes são iguais.~n') ; format('As matrizes são diferentes.~n')),    random_number(RandomNumber),
%
%
